        ...
        <div className="max-w-6xl mx-auto">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 mt-4">
                        <Link
                          to={`/user/job/${job._id}`}
                          className="flex items-center gap-2 px-4 py-2 text-sm text-(--text) bg-(--secondary) rounded-lg hover:bg-(--secondary)/50 transition"
                        >
          ...
          {jobs.length === 0 && !loading && (
            <div className="text-center mt-20">
              ...
              <Link
                to="/user/create-job"
                className="mt-4 inline-block px-6 py-3 bg-(--accent) text-white rounded-lg hover:bg-(--accent-hover) transition"
              >
                Post Your First Job
              </Link>
            </div>
